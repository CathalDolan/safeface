...
class Product(models.Model):
    ...
    price_1 = models.DecimalField(max_digits=6, decimal_places=2, default=1)
    qty_2 = models.IntegerField(default=100)
    price_2 = models.DecimalField(max_digits=6, decimal_places=2, default=0.9)
    qty_3 = models.IntegerField(default=250)
    price_3 = models.DecimalField(max_digits=6, decimal_places=2, default=0.8)
