...
def cache_checkout_data(request):
    try:
        ...
        messages.error(request, 'Sorry, your payment can\'t be \
            processed at the moment. Try again later.')
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            # Commit=False prevents multipe saves of the same order
        ...
        # Prefill the checkout form with the Users profile data
    ...
    # Developer alert if we forget to set public key
